...
def interet_const_rob_ore(blueprint, e):
    #return e.nb_ore < max(blueprint.pr_rob_ore, blueprint.pr_rob_clay, blueprint.pr_rob_obs_ore, blueprint.pr_rob_geo_ore)
    return e.nb_rob_ore < max(blueprint.pr_rob_ore, blueprint.pr_rob_clay, blueprint.pr_rob_obs_ore, blueprint.pr_rob_geo_ore)
...
def possible_const_rob_clay(blueprint, e):
    return e.nb_ore >= blueprint.pr_rob_clay

def interet_const_rob_clay(blueprint, e):
    return e.nb_rob_clay < blueprint.pr_rob_obs_clay
...
def quality(blueprint):
    ...
    def deroule(blueprint, minute, etat):
        ...
        elif possible_const_rob_obs(blueprint, etat):
            deroule(blueprint, minute+1, change_const_rob_obs(blueprint, changed(etat)))
        
        else: 
            if interet_const_rob_clay(blueprint, etat) and possible_const_rob_clay(blueprint, etat):
                deroule(blueprint, minute+1, change_const_rob_clay(blueprint, changed(etat)))
                    
            if interet_const_rob_ore(blueprint, etat) and possible_const_rob_ore(blueprint, etat):
